...
// Non-streaming compact prompt (kept for parity; the live Ollama path streams).
const SYSTEM_PROMPT_COMPACT = `You detect AI-generated text. ${OLLAMA_GUIDANCE}

Return ONLY valid JSON, no prose, exactly this shape:
{"segments":[{"id":"<id>","p_ai":0.00,"signals":[]}]}
